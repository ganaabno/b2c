...
import axios from "axios"; // Use axios directly or via a helper
...
export default function SignupManager() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // We call the backend route we just created
      await axios.post("/api/requests/manager", formData);
    ...
    return (
      <div className="mx-auto max-w-md rounded-xl bg-white p-8 shadow-2xl text-center">
        ...
        <p className="text-gray-600 mb-6">
          Your application to become a Manager has been submitted. An
          administrator will review your details shortly.
        </p>
